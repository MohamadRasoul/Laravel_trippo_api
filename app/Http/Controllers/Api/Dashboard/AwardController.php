...
use App\Http\Resources\Dashboard\AwardResource;
...
class AwardController extends Controller
{
    ...
    {
        $awards = Award::orderBy('id');

        return response()->success(
            'this is all Awards',
            [
                "awards" => AwardResource::collection($awards->paginate(request()->perPage ?? $awards->count())),
            ]
        );
    }
     ...
     *           @OA\Schema(ref="#/components/schemas/StoreAwardRequest")
     *       )
     *    ),
     *
     *
     ...
     *              property="message",
     *              type="string",
     *              example="award is added success"
     *           ),
     *           @OA\Property(
     *              property="data",
     *                 @OA\Property(
     ...
     *        required=true,
     *        @OA\MediaType(mediaType="application/json",
     *           @OA\Schema(ref="#/components/schemas/UpdateAwardRequest")
     *       )
     *    ),
     *
     *
     ...
     *              property="message",
     *              type="string",
     *              example="award is updated success"
     *           ),
     *           @OA\Property(
     *              property="data",
     *              @OA\Property(
     ...
     *              property="message",
     *              type="string",
     *              example="award is deleted success"
     *           ),
     *        ),
     *     ),
     *
    ...
    public function destroy(Award $award)
    {
        ...
        return response()->success('award is deleted success');
    }
}
