...
class AnswerController extends Controller
{
    // /**
    //  * @OA\Get(
    //  *    path="/api/dashboard/answer/index",
    ...
    // /**
    //  * @OA\Post(
    //  *    path="/api/dashboard/answer/store",
    ...
    // /**
    //  * @OA\Get(
    //  *    path="/api/dashboard/answer/{id}/show",
    ...
    // /**
    //  * @OA\Post(
    //  *    path="/api/dashboard/answer/{id}/update",
    ...
    //  *        required=true,
    //  *        @OA\MediaType(mediaType="application/json",
    //  *           @OA\Schema(ref="#/components/schemas/UpdateAnswerRequest")
    //  *       )
    //  *    ),
    //  *
    //  *
    ...
    //  *              property="message",
    //  *              type="string",
    //  *              example="answer is updated success"
    //  *           ),
    //  *           @OA\Property(
    //  *              property="data",
    //  *              @OA\Property(
