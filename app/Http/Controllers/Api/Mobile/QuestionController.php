...
class QuestionController extends Controller
{
    // /**
    //  * @OA\Get(
    //  *    path="/api/mobile/question/index",
    ...
    // /**
    //  * @OA\Post(
    //  *    path="/api/mobile/question/store",
    ...
    // /**
    //  * @OA\Post(
    //  *    path="/api/mobile/question/{id}/update",
    ...
    //  *              property="message",
    //  *              type="string",
    //  *              example="question is updated success"
    //  *           ),
    //  *           @OA\Property(
    //  *              property="data",
    //  *              @OA\Property(
