...
class NotificationController extends Controller
{
    // /** 
    //  * @OA\Get(
    //  *    path="/api/mobile/notification/index",
    ...
    // /** 
    //  * @OA\Post(
    //  *    path="/api/mobile/notification/store",
    ...
    // /** 
    //  * @OA\Get(
    //  *    path="/api/mobile/notification/{id}/show",
    ...
    // /** 
    //  * @OA\Post(
    //  *    path="/api/mobile/notification/{id}/update",
    ...
    // /** 
    //  * @OA\Delete(
    //  *    path="/api/mobile/notification/{id}/delete",
